...
// Source: github.com/authelia/goauth2/handler/oauth2 (interfaces: AccessTokenStrategy)
//
...
func (m *MockAccessTokenStrategy) GenerateAccessToken(arg0 context.Context, arg1 goauth2.Requester) (string, string, error) {
	m.ctrl.T.Helper()
...
func (m *MockAccessTokenStrategy) ValidateAccessToken(arg0 context.Context, arg1 goauth2.Requester, arg2 string) error {
	m.ctrl.T.Helper()
