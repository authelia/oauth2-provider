...
// Source: github.com/authelia/goauth2 (interfaces: TokenIntrospector)
//
...
func (m *MockTokenIntrospector) IntrospectToken(arg0 context.Context, arg1 string, arg2 goauth2.TokenType, arg3 goauth2.AccessRequester, arg4 []string) (goauth2.TokenType, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "IntrospectToken", arg0, arg1, arg2, arg3, arg4)
	ret0, _ := ret[0].(goauth2.TokenType)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
