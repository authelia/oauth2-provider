...
// Source: github.com/authelia/goauth2/handler/openid (interfaces: OpenIDConnectRequestStorage)
//
...
func (m *MockOpenIDConnectRequestStorage) CreateOpenIDConnectSession(arg0 context.Context, arg1 string, arg2 goauth2.Requester) error {
	m.ctrl.T.Helper()
...
func (m *MockOpenIDConnectRequestStorage) GetOpenIDConnectSession(arg0 context.Context, arg1 string, arg2 goauth2.Requester) (goauth2.Requester, error) {
	m.ctrl.T.Helper()
