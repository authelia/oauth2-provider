...
// Source: github.com/authelia/goauth2 (interfaces: Client)
//
...
func (m *MockClient) GetAudience() goauth2.Arguments {
	m.ctrl.T.Helper()
...
func (m *MockClient) GetGrantTypes() goauth2.Arguments {
	m.ctrl.T.Helper()
...
func (m *MockClient) GetResponseTypes() goauth2.Arguments {
	m.ctrl.T.Helper()
...
func (m *MockClient) GetScopes() goauth2.Arguments {
	m.ctrl.T.Helper()
