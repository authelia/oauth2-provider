...
// Source: github.com/authelia/goauth2/handler/pkce (interfaces: PKCERequestStorage)
//
...
func (m *MockPKCERequestStorage) CreatePKCERequestSession(arg0 context.Context, arg1 string, arg2 goauth2.Requester) error {
	m.ctrl.T.Helper()
...
func (m *MockPKCERequestStorage) GetPKCERequestSession(arg0 context.Context, arg1 string, arg2 goauth2.Session) (goauth2.Requester, error) {
	m.ctrl.T.Helper()
