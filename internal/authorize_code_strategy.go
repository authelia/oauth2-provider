...
// Source: github.com/authelia/goauth2/handler/oauth2 (interfaces: AuthorizeCodeStrategy)
//
...
func (m *MockAuthorizeCodeStrategy) GenerateAuthorizeCode(arg0 context.Context, arg1 goauth2.Requester) (string, string, error) {
	m.ctrl.T.Helper()
...
func (m *MockAuthorizeCodeStrategy) ValidateAuthorizeCode(arg0 context.Context, arg1 goauth2.Requester, arg2 string) error {
	m.ctrl.T.Helper()
