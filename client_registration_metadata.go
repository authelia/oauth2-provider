...
type ClientRegistrationMetadata struct {
	...
	PushedAuthorizationRequestEndpointAuthMethod     string   `json:"pushed_authorization_request_endpoint_auth_method,omitempty"`
	PushedAuthorizationRequestEndpointAuthSigningAlg string   `json:"pushed_authorization_request_endpoint_auth_signing_alg,omitempty"`
