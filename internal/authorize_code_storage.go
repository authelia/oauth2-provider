...
// Source: github.com/authelia/goauth2/handler/oauth2 (interfaces: AuthorizeCodeStorage)
//
...
func (m *MockAuthorizeCodeStorage) CreateAuthorizeCodeSession(arg0 context.Context, arg1 string, arg2 goauth2.Requester) error {
	m.ctrl.T.Helper()
...
func (m *MockAuthorizeCodeStorage) GetAuthorizeCodeSession(arg0 context.Context, arg1 string, arg2 goauth2.Session) (goauth2.Requester, error) {
	m.ctrl.T.Helper()
