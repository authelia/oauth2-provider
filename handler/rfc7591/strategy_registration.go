...
func (s *DefaultClientRegistrationStrategy) MetadataFromClient(ctx context.Context, client oauth2.Client) (metadata *oauth2.ClientRegistrationMetadata, err error) {
	...
	return &oauth2.ClientRegistrationMetadata{
		...
		PushedAuthorizationRequestEndpointAuthMethod:     registered.PushedAuthorizationRequestEndpointAuthMethod,
		PushedAuthorizationRequestEndpointAuthSigningAlg: registered.PushedAuthorizationRequestEndpointAuthSigningAlg,
...
func (s *DefaultClientRegistrationStrategy) apply(registered *oauth2.DefaultRegisteredClient, metadata *oauth2.ClientRegistrationMetadata) {
	...
	registered.PushedAuthorizationRequestEndpointAuthMethod = metadata.PushedAuthorizationRequestEndpointAuthMethod
	registered.PushedAuthorizationRequestEndpointAuthSigningAlg = metadata.PushedAuthorizationRequestEndpointAuthSigningAlg
...
var _ oauth2.ClientRegistrationStrategy = (*DefaultClientRegistrationStrategy)(nil)
