...
// Source: github.com/authelia/goauth2/handler/oauth2 (interfaces: AccessTokenStorage)
//
...
func (m *MockAccessTokenStorage) CreateAccessTokenSession(arg0 context.Context, arg1 string, arg2 goauth2.Requester) error {
	m.ctrl.T.Helper()
...
func (m *MockAccessTokenStorage) GetAccessTokenSession(arg0 context.Context, arg1 string, arg2 goauth2.Session) (goauth2.Requester, error) {
	m.ctrl.T.Helper()
