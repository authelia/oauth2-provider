...
// Source: github.com/authelia/goauth2/handler/openid (interfaces: OpenIDConnectTokenStrategy)
//
...
func (m *MockOpenIDConnectTokenStrategy) GenerateIDToken(arg0 context.Context, arg1 time.Duration, arg2 goauth2.Requester) (string, error) {
	m.ctrl.T.Helper()
