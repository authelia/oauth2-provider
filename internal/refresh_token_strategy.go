...
// Source: github.com/authelia/goauth2/handler/oauth2 (interfaces: RefreshTokenStrategy)
//
...
func (m *MockRefreshTokenStrategy) GenerateRefreshToken(arg0 context.Context, arg1 goauth2.Requester) (string, string, error) {
	m.ctrl.T.Helper()
...
func (m *MockRefreshTokenStrategy) ValidateRefreshToken(arg0 context.Context, arg1 goauth2.Requester, arg2 string) error {
	m.ctrl.T.Helper()
