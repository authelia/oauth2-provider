...
// Source: github.com/authelia/goauth2 (interfaces: Requester)
//
...
func (m *MockRequester) GetClient() goauth2.Client {
	m.ctrl.T.Helper()
...
func (m *MockRequester) GetGrantedAudience() goauth2.Arguments {
	m.ctrl.T.Helper()
...
func (m *MockRequester) GetGrantedScopes() goauth2.Arguments {
	m.ctrl.T.Helper()
...
func (m *MockRequester) GetRequestedAudience() goauth2.Arguments {
	m.ctrl.T.Helper()
...
func (m *MockRequester) GetRequestedScopes() goauth2.Arguments {
	m.ctrl.T.Helper()
...
func (m *MockRequester) GetSession() goauth2.Session {
	m.ctrl.T.Helper()
...
func (m *MockRequester) Merge(arg0 goauth2.Requester) {
	m.ctrl.T.Helper()
...
func (m *MockRequester) Sanitize(arg0 []string) goauth2.Requester {
	m.ctrl.T.Helper()
...
func (m *MockRequester) SetRequestedAudience(arg0 goauth2.Arguments) {
	m.ctrl.T.Helper()
...
func (m *MockRequester) SetRequestedScopes(arg0 goauth2.Arguments) {
	m.ctrl.T.Helper()
...
func (m *MockRequester) SetSession(arg0 goauth2.Session) {
	m.ctrl.T.Helper()
