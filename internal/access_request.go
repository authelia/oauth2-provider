...
// Source: github.com/authelia/goauth2 (interfaces: AccessRequester)
//
...
func (m *MockAccessRequester) GetClient() goauth2.Client {
	m.ctrl.T.Helper()
...
func (m *MockAccessRequester) GetGrantTypes() goauth2.Arguments {
	m.ctrl.T.Helper()
...
func (m *MockAccessRequester) GetGrantedAudience() goauth2.Arguments {
	m.ctrl.T.Helper()
...
func (m *MockAccessRequester) GetGrantedScopes() goauth2.Arguments {
	m.ctrl.T.Helper()
...
func (m *MockAccessRequester) GetRequestedAudience() goauth2.Arguments {
	m.ctrl.T.Helper()
...
func (m *MockAccessRequester) GetRequestedScopes() goauth2.Arguments {
	m.ctrl.T.Helper()
...
func (m *MockAccessRequester) GetSession() goauth2.Session {
	m.ctrl.T.Helper()
...
func (m *MockAccessRequester) Merge(arg0 goauth2.Requester) {
	m.ctrl.T.Helper()
...
func (m *MockAccessRequester) Sanitize(arg0 []string) goauth2.Requester {
	m.ctrl.T.Helper()
...
func (m *MockAccessRequester) SetRequestedAudience(arg0 goauth2.Arguments) {
	m.ctrl.T.Helper()
...
func (m *MockAccessRequester) SetRequestedScopes(arg0 goauth2.Arguments) {
	m.ctrl.T.Helper()
...
func (m *MockAccessRequester) SetSession(arg0 goauth2.Session) {
	m.ctrl.T.Helper()
