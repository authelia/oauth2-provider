...
// Source: github.com/authelia/goauth2 (interfaces: AuthorizeEndpointHandler)
//
...
func (m *MockAuthorizeEndpointHandler) HandleAuthorizeEndpointRequest(arg0 context.Context, arg1 goauth2.AuthorizeRequester, arg2 goauth2.AuthorizeResponder) error {
	m.ctrl.T.Helper()
